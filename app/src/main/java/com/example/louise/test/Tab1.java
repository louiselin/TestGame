                    ...
                    for (int j = 0; j < userbadgelist.length(); j++) {
                        ...
                        if (w == x) {
                            ...
                            res =  jsonlist.getJSONObject(i).getString("name")
                                    + jsonlist.getJSONObject(i).getString("description");
...
//                            + "  條件:" + jsonlist.getJSONObject(i).getString("description") + "\n";
            ...
            if(res == "") {
                res = "AHHHH,HA!! Newbie!";
                TextView myTextView0 = (TextView) findViewById(R.id.tab1text);
                myTextView0.setText(res);
            } else {
                TextView myTextView0 = (TextView) findViewById(R.id.tab1text);
                myTextView0.setText(" 名稱條件:" + res);
            }
